...
- (instancetype)initWithAuthKey:(NSData *)authKey authKeyId:(int64_t)authKeyId saltSet:(NSArray *)saltSet authKeyAttributes:(NSDictionary *)authKeyAttributes mainTempAuthKey:(NSData *)mainTempAuthKey mediaTempAuthKey:(NSData *)mediaTempAuthKey;
